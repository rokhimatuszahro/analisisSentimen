...
class NodeInfoGcsServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetAllHeartbeat = channel.unary_unary(
        '/ray.rpc.NodeInfoGcsService/GetAllHeartbeat',
        request_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetAllHeartbeatRequest.SerializeToString,
        response_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetAllHeartbeatReply.FromString,
        )
    self.ReportResourceUsage = channel.unary_unary(
        '/ray.rpc.NodeInfoGcsService/ReportResourceUsage',
    ...
    self.GetAllResourceUsage = channel.unary_unary(
        '/ray.rpc.NodeInfoGcsService/GetAllResourceUsage',
...
class NodeInfoGcsServiceServicer(object):
  ...
  def GetAllHeartbeat(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_NodeInfoGcsServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetAllHeartbeat': grpc.unary_unary_rpc_method_handler(
          servicer.GetAllHeartbeat,
          request_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetAllHeartbeatRequest.FromString,
          response_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetAllHeartbeatReply.SerializeToString,
      ),
